...
<template>
  <div
    class="bg-[#111111] border border-[#222222] rounded-xl overflow-hidden shadow-[0_0_20px_rgba(255,255,255,0.0625)]"
  >
    <div
    ...
    <div class="px-6 py-4 text-center bg-[#151515] rounded-b-lg border-t border-[#222222] relative z-10">
      <NuxtLink
        v-if="path"
        :to="path"
        class="text-[12px] font-semibold text-[#cccccc] hover:text-[#009367]"
      >
