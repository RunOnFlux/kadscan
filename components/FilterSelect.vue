...
<template>
  <div class="relative" v-outside="closeDropdown">
    ...
    <button
      ...
      class="flex items-center justify-center px-2 py-[5px] text-[12px] font-normal text-font-primary bg-surface-disabled border border-[#222222] rounded-md hover:bg-surface-hover whitespace-nowrap ring-0 outline-none"
    >
      ...
      >
        <div class="flex flex-col gap-3">
          ...
          <div class="flex gap-2">
           ...
           <button
             @click="selectAll"
             class="px-2 py-1 text-[12px] font-normal text-[#6ab5db] bg-surface-disabled border border-[#222222] rounded-md hover:text-font-primary hover:bg-[#0784c3] whitespace-nowrap transition-colors duration-300"
           >
             All Chains
           </button>
          ...
          <div class="flex items-center gap-1">
            ...
            <button
              ...
              class="flex items-center justify-center w-8 h-8 border border-[#222222] bg-surface-disabled rounded-md text-[#6ab5db] hover:text-font-primary hover:bg-[#0784c3] disabled:hover:bg-surface-disabled disabled:bg-surface-disabled disabled:text-font-tertiary transition-colors duration-300"
            ...
            <input
              ...
              class="w-12 h-8 text-center text-sm bg-surface-disabled border border-[#222222] rounded-md text-font-primary focus:outline-none transition-colors duration-300 hover:border-[#0784c3] focus:border-[#0784c3] [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
              placeholder="0"
            />
          ...
          <div v-if="enableBlockFilter" class="flex gap-2 items-center">
            ...
            <div class="grid grid-cols-[1fr_auto] items-center gap-1 w-full">
              <input
                ...
                @focus="$event.target.select()"
                class="w-full h-8 px-2 text-sm bg-surface-disabled border border-[#222222] rounded-md text-font-primary focus:outline-none transition-colors duration-300 hover:border-[#0784c3] focus:border-[#0784c3] [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                placeholder="Height"
              />
              <button
