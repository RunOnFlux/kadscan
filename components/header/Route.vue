...
<template>
  <div>
    <NuxtLink
      ...
      class="px-3 py-[15px] text-[15px] text-[#bbbbbb] hover:text-[#00e19d] block"
    >
      {{ props.label }}
    </NuxtLink>
    ...
    >
      <NuxtLink
        :to="props.path || ''"
        :class="data.open ? 'text-[#00e19d]' : 'text-[#bbbbbb]'"
          ...
          >
            ...
            >
              <NuxtLink
                ...
                :to="subroute.path"
                :key="subroute.tag"
                class="p-3 text-sm text-[#bbbbbb] hover:text-[#00e19d]"
