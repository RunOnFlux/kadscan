...
<template>
  <nav class="flex items-stretch gap-0.5" aria-label="Pagination">
    <button
      ...
      @click="goToFirst"
      class="relative whitespace-nowrap inline-flex items-center px-2 py-1 rounded-md border border-[#222222] bg-surface-primary text-xs font-normal text-[#6ab5db] hover:text-font-primary hover:bg-[#0784c3] disabled:hover:bg-surface-disabled disabled:bg-surface-disabled disabled:text-font-tertiary transition-colors duration-300"
    >
      First
    </button>
    <button
    ...
    <span class="relative whitespace-nowrap inline-flex items-center px-2 py-1 rounded-md border border-[#222222] bg-surface-disabled text-xs font-normal text-font-tertiary cursor-default">
