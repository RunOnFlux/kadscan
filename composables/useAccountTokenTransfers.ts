...
const GQL_QUERY = `
  query Transfers($accountName: String, $chainId: String, $after: String, $before: String, $first: Int, $last: Int) {
    transfers(accountName: $accountName, chainId: $chainId, after: $after, before: $before, first: $first, last: $last) {
      totalCount
      pageInfo {
        endCursor
        hasNextPage
