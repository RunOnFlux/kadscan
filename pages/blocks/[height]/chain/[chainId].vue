...
const textContent = {
  blockHeight: { label: 'Block Height:', description: 'The blockchain growth increased by one with each new block.' },
  chainId: { label: 'Chain ID:', description: 'The chain index (0–19) where this block was mined.' },
  status: { label: 'Status:', description: 'The block’s finality status.' },
  creationTime: { label: 'Creation Time:', description: 'The date and time the block was produced.' },
  transactions: { label: 'Transactions:', description: 'Total number of transactions included in this block.' },
  events: { label: 'Events:', description: 'Total events emitted by transactions in this block.' },
  minerAccount: { label: 'Miner Account:', description: 'Address that received fees for producing this block.' },
  blockReward: { label: 'Block Reward:', description: 'The block producer’s reward in Kadena (KDA), in addition to all transaction fees.' },
  difficulty: { label: 'Difficulty:', description: 'Cumulative network difficulty up to this block.' },
  nonce: { label: 'Nonce:', description: 'A random value used by miners to create a valid proof-of-work hash.' },
  gasUsed: { label: 'Gas Used:', description: 'Total gas consumed and the percentage of the block’s gas capacity used.' },
  gasLimit: { label: 'Gas Limit:', description: 'Maximum gas permitted per block.' },
  gasPrice: { label: 'Gas Price:', description: 'Average gas price per unit for transactions in this block, in Kadena (KDA).' },
  kadenaPrice: { label: 'Kadena Price:', description: 'Closing price of Kadena (KDA) on the date this block was produced.' },
  epoch: { label: 'Epoch:', description: 'Start time of the current epoch.' },
  flags: { label: 'Flags:', description: 'Hex-encoded configuration bits.' },
  target: { label: 'Target:', description: 'A valid proof-of-work hash must be below this value.' },
  weight: { label: 'Weight:', description: 'Cumulative chain weight (difficulty) up to this block.' },
  hash: { label: 'Hash:', description: 'Unique header hash of this block.' },
  parentHash: { label: 'Parent Hash:', description: 'Header hash of the previous block in this chain.' },
  powHash: { label: 'POW Hash:', description: 'Result of the proof-of-work computation.' },
  payloadHash: { label: 'Payload Hash:', description: 'Hash of the block’s transaction payload.' },
  neighbor: { label: 'Neighbor at Chain #', description: 'Block at the same height on another chain.' },
